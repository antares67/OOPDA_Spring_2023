...
public class CoffeeBox extends VBox {
	...
	public double getCoffeeCost()
	{
		...
		if (cbNone.isSelected()){coffeeCost+=NONE;}
		if (cbRegular.isSelected()){coffeeCost+=REG;}
		if (cbDecaf.isSelected()){coffeeCost+=DECAF;}
		if (cbCappuccino.isSelected()){coffeeCost+=CAPP;}
